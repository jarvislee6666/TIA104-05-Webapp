		...
		<table>
			...
			<tr>
				...
				<td><select name="admSta">
						<option value="true"
							<%=(admVO.getAdmSta() != null && admVO.getAdmSta()) ? "selected" : ""%>>在職</option>
						<option value="false"
							<%=(admVO.getAdmSta() != null && !admVO.getAdmSta()) ? "selected" : ""%>>離職</option>
				</select></td>
			</tr>
			<tr>
				<td>雇用日:</td>
			...
			<tr>
				...
				<td><select name="supvsr">
						<option value="true"
							<%=(admVO.getSupvsr() != null && admVO.getSupvsr()) ? "selected" : ""%>>是</option>
						<option value="false"
							<%=(admVO.getSupvsr() != null && !admVO.getSupvsr()) ? "selected" : ""%>>否</option>
				</select></td>
			</tr>
